"""Czech display formatting utilities for BeCoMe examples."""
...
def display_case_header(
    ...
    """
    Display case study header with metadata in Czech.

    :param case_name: Name of the case study
...
def display_centroid(fuzzy_number: FuzzyTriangleNumber, name: str = "Těžiště") -> None:
    """
    Display centroid calculation in standard format.

    :param fuzzy_number: Fuzzy number to display centroid for
    :param name: Label for the centroid
    """
