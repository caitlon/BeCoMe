...
def main(calculator: BaseAggregationCalculator | None = None) -> None:
    ...
    display_case_header("PŘÍPAD PENDLEŘI", opinions, metadata)
    ...
    print(f"\nOdhad nejlepšího kompromisu: {best_compromise_centroid:.2f} (těžiště)")
    print(
    ...
    # Czech translations for Likert decisions
    decision_cs = {
    ...
    print(f"\nROZHODNUTÍ (na základě těžiště {best_compromise_centroid:.2f}):")
