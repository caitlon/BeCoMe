...
- [Mathematical foundation](#mathematical-foundation)
    - [1. Fuzzy triangular numbers](#1-fuzzy-triangular-numbers)
    - [2. Centroid calculation](#2-centroid-calculation)
- [The BeCoMe algorithm, step by step](#the-become-algorithm-step-by-step)
    - [Input](#input)
    - [Step 1: calculate the arithmetic mean (Γ)](#step-1-calculate-the-arithmetic-mean-γ)
    - [Step 2: calculate the median (Ω)](#step-2-calculate-the-median-ω)
    - [Step 3: calculate the best compromise (ΓΩMean)](#step-3-calculate-the-best-compromise-γωmean)
    - [Step 4: calculate the maximum error (Δmax)](#step-4-calculate-the-maximum-error-δmax)
    - [Step 5: summary of results](#step-5-summary-of-results)
- [A complete worked example](#a-complete-worked-example)
    - [Scenario: estimating a project budget](#scenario-estimating-a-project-budget)
    - [Solution](#solution)
