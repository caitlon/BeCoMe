...
- [The BeCoMe algorithm, step by step](#the-become-algorithm-step-by-step)
  - [Input](#input)
  - [Step 1: calculate the arithmetic mean (Γ)](#step-1-calculate-the-arithmetic-mean)
  - [Step 2: calculate the median (Ω)](#step-2-calculate-the-median)
  - [Step 3: calculate the best compromise (ΓΩMean)](#step-3-calculate-the-best-compromise-mean)
  - [Step 4: calculate the maximum error (Δmax)](#step-4-calculate-the-maximum-error-max)
