...
#### [fuzzy_number.py](https://github.com/caitlon/BeCoMe/blob/prod/src/models/fuzzy_number.py)
...
#### [expert_opinion.py](https://github.com/caitlon/BeCoMe/blob/prod/src/models/expert_opinion.py)
...
#### [become_result.py](https://github.com/caitlon/BeCoMe/blob/prod/src/models/become_result.py)
...
#### [likert_interpreter.py](https://github.com/caitlon/BeCoMe/blob/prod/src/interpreters/likert_interpreter.py)
